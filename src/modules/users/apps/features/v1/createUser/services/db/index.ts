...
interface ICreateUserDbService extends IServiceHandlerAsync<ICreateUserDbServiceParameters,ICreateUserDbServiceResults>{
...
export class CreateUserDbService implements ICreateUserDbService {
  public async handleAsync(params: ICreateUserDbServiceParameters): Promise<Result<ICreateUserDbServiceResults, ResultError>> {
    try
    {
      if(!params)
